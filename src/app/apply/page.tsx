    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <Reveal hover className="result-card mb-16 p-8">
          <h2 className="mb-4 scroll-mt-24 text-center text-3xl font-bold text-white" id="information-sessions">Fall 2026 Recruiting Schedule</h2>
          <p className="mx-auto mb-10 max-w-3xl text-center text-lg text-gray-300">
            Interested in learning more about all of our subteams and how they work together throughout the vehicle development process? Join us at one of our events to hear from members across the team and ask any questions you may have!
          </p>
          <div className="mx-auto max-w-3xl">
            <div className="relative space-y-10 md:space-y-12">
              <div className="absolute bottom-20 left-1/2 top-8 hidden w-px -translate-x-1/2 bg-red-900/80 md:block" />
              ...
              <div className="relative grid items-center gap-4 md:grid-cols-[1fr_auto_1fr] md:gap-6">
                ...
                <div className="border border-red-900/70 bg-gray-950 p-5 text-center shadow-lg shadow-black/20 md:text-left">
                  ...
                  <p className="text-base font-semibold text-red-300">Olin 255 @ 5pm</p>
                </div>
              </div>
              ...
              <div className="relative grid items-center gap-4 md:grid-cols-[1fr_auto_1fr] md:gap-6">
                <div className="order-2 border border-red-900/70 bg-gray-950 p-5 text-center shadow-lg shadow-black/20 md:order-none md:text-right">
                  ...
                  <p className="text-base font-semibold text-red-300">Phillips 101 @ 5pm</p>
                </div>
              ...
              <div className="relative grid items-center gap-4 md:grid-cols-[1fr_auto_1fr] md:gap-6">
                ...
                <div className="border border-red-900/70 bg-gray-950 p-5 text-center shadow-lg shadow-black/20 md:text-left">
                  ...
                  <p className="text-base font-semibold text-red-300">RPCC 205 @ 5pm</p>
                </div>
              </div>

              <div className="relative grid items-center gap-4 md:grid-cols-[1fr_auto_1fr] md:gap-6">
                <div className="order-2 border border-red-900/70 bg-gray-950 p-5 text-center shadow-lg shadow-black/20 md:order-none md:text-right">
                  <h3 className="mb-2 text-xl font-bold text-white">Open House</h3>
                  <p className="text-base font-semibold text-red-300">Upson B56 from 4:30-7:30pm</p>
                </div>
                <div className="hidden h-4 w-4 rounded-full border-4 border-gray-950 bg-red-700 shadow-[0_0_0_4px_rgba(127,29,29,0.35)] md:block" />
                <div className="order-1 flex justify-center md:order-none md:justify-start">
                  <div className="inline-flex items-center gap-2 border border-red-800 bg-red-700 px-4 py-2 text-sm font-bold uppercase tracking-[0.08em] text-white shadow-lg shadow-red-950/30">
              ...
              <div className="relative flex flex-col items-center gap-4 pt-1">
                <div className="hidden h-4 w-4 rounded-full border-4 border-gray-950 bg-red-500 shadow-[0_0_0_4px_rgba(127,29,29,0.35)] md:block" />
                <div className="w-full max-w-md border border-red-700 bg-gray-950 p-5 text-center shadow-lg shadow-black/20">
                  <h3 className="mb-2 text-xl font-bold text-white">APPLICATION DEADLINE</h3>
                  <p className="text-base font-semibold text-red-300">Thursday, October 15 @ 11:59pm</p>
                </div>
              </div>
            </div>
          </div>
