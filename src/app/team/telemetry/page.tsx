    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="bg-gradient-to-r from-red-600 to-red-700 py-16 pt-24 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            The Telemetry subteam uses web, mobile, and IoT technology to
            collect, analyze, and display data from vehicle testing. We&apos;re
            responsible for the high-frequency data collection, storage, and
            efficiency analysis required for data-driven engineering.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-300">
                A mobile app that is both a driver dashboard and a data tunnel,
                forwarding electrical DAQ data to the Live Timing Dashboard.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300">
                A web-based dashboard useful for competition preparation that
                displays stats such as speed and battery level in real-time.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300">
                A forward-looking project aiming to display Driver Dashboard
                contents directly on the competition vehicle windshield.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-300 text-lg">
              Our team is dedicated to leveraging cutting-edge technology to
              enhance vehicle performance and data analysis. We specialize in
              creating tools that provide real-time insights and improve the
              overall efficiency of our engineering processes.
            </p>
          </motion.div>
