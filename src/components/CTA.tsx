    ...
    <>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <Link
            href="/apply"
            className="group text-white px-8 py-4 rounded-none text-xl font-semibold transition-all transform hover:scale-105 shadow-lg flex items-center gap-3"
          ...
          <Link
            href="/vehicles"
            className="border-2 border-white text-white hover:bg-white hover:text-gray-900 px-8 py-4 rounded-none text-xl font-semibold transition-all transform hover:scale-105"
          >
            View Our Vehicles
          </Link>
        </motion.div>
